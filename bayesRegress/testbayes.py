...
# b, var = bR.IRWLS(yi,design)
bR.IRWLS(yi,design, link='logit', tol=1e-8, verbose=True)

betas, beta_means = bR.hhProbit(yi, design, b, v, 10000)
...
# # bR.IRWLS(Pyi,Pdesign, 'probit')

# # #finneyBetas = bR.hhProbit(yi, design, b, v, 5000)
# PimaIndianBetas, PimaMeans = bR.hhProbit(Pyi, Pdesign, Pb, Pv, 10000)
